...
Six guardrails protect this service. Each link below is the atomic note with the real code,
...
* [[../Guardrails/Structured-Logging-and-Data-Masking]] - SLF4J log-level policy; API keys and password-equivalents never logged, in any form (URL-601).
